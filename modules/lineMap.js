...
const TWLD_ASSETS_BASE = String(win.DS_ASSETS_BASE || "https://ds.rero.space").replace(/\/$/, "");
const TWLD_KORRIDORE_246_URL = `${TWLD_ASSETS_BASE}/maps/korridore_246.js`;
