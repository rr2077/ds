...
(function () {
  ...
  function ensureMassSupporterStyles() {
    if (document.getElementById("ds-mass-supporter-styles")) return;
    const style = document.createElement("style");
    style.id = "ds-mass-supporter-styles";
    style.textContent = `
      ...
      #div_container .scriptInput:disabled {
        opacity: .75;
      }
      #div_container a {
        color: inherit;
