...
(() => {
  ...
  const POPUP = {
    ...
    profileImage:
      "https://ds.rero.space/assets/Okay_Emote_NoYellow.png",
    headerNote:
    ...
    body: [
      ...
      "Das Repository bleibt natürlich offen: Ihr könnt gerne die Version unter ds.rero.space nutzen und eigene Anpassungen einbauen.",
      "Wenn euch das Tool hilft, teilt es gern mit Freunden, Familie und euren Stammesmitgliedern.",
    ],
    links: [
      {
        label: "DS-Tools",
        href: "https://ds.rero.space/",
      },
      {
        label: "Userscript",
        href: "https://ds.rero.space/main.user.js",
      },
      {
        label: "Manifest",
        href: "https://ds.rero.space/config/manifest.prod.json",
      },
    ],
